package com.example.sensors.view;
...
public class CompassView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("N", ((float) (xPoint + radius * Math.sin((double) (-position) /180 * 3.143 ))),
                (  (float) ( yPoint - radius * Math.cos((double)  (-position) / 180 * 3.143)) ) , paint );

        canvas.drawText(String.valueOf(position),xPoint + 20,yPoint,paint);
