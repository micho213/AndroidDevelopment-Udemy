...
public class ReflexView extends View {
    ...
    public static final int SPOT_DIAMETER = 250;
    public static final float SCALE_X = 0.25f;
    public static final float SCALE_Y = 0.25f;
    public static final int INITIAL_SPOTS = 3;
...
//        player.play(soundId, volume, volume, 1, 0, speed);
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        if (soundPool != null)
            soundPool.play(MISS_SOUND_ID, volume, volume, SOUND_PRIORITY, 0, 1.0F);


        score -= 2; // remove some points
